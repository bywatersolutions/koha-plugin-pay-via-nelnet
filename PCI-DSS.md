...
|---|---|---|
| [`nelnet_plugin_tokens`](https://github.com/bywatersolutions/koha-plugin-pay-via-nelnet/blob/2df78b7f516818987421995af919a8a037674acb/Koha/Plugin/Com/ByWaterSolutions/PayViaNelnet.pm#L445) | one-time token, created_on, borrowernumber | Deleted on successful payment; rows from abandoned checkouts accumulate (no purge; FK cascade on patron deletion is the only reaper). Not dropped on [uninstall](https://github.com/bywatersolutions/koha-plugin-pay-via-nelnet/blob/2df78b7f516818987421995af919a8a037674acb/Koha/Plugin/Com/ByWaterSolutions/PayViaNelnet.pm#L464). |
